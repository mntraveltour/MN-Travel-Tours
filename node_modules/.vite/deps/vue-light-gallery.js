...
// node_modules/vue-light-gallery/dist/vue-light-gallery.esm.js
var keyMap = {
  LEFT: 37,
  RIGHT: 39,
  ESC: 27
...
var script = {
  ...
  methods: {
    ...
    getImageElByIndex: function getImageElByIndex(index2) {
      var elements = this.$refs["lg-img-" + index2] || [];
      return elements[0];
    },
    setImageLoaded: function setImageLoaded(index2) {
      var el = this.getImageElByIndex(index2);
      this.isImageLoaded = !el ? false : el.classList.contains("loaded");
    },
    shouldPreload: function shouldPreload(index2) {
      var el = this.getImageElByIndex(index2) || {};
      var src = el.src;
      return !!src || index2 === this.currentIndex || index2 === this.currentIndex - 1 || index2 === this.currentIndex + 1;
    },
...
function addStyle(id, css) {
  ...
  if (!style.ids.has(id)) {
    ...
    if ("styleSheet" in style.element) {
      ...
      var index2 = style.ids.size - 1;
      var textNode = document.createTextNode(code);
      var nodes = style.element.childNodes;
      if (nodes[index2]) {
        style.element.removeChild(nodes[index2]);
      }
      if (nodes.length) {
        style.element.insertBefore(textNode, nodes[index2]);
      } else {
      ...
      [
        _c(
          ...
          [
                ...
                _vm._l(_vm.formattedImages, function(image, imageIndex) {
                  return _c(
                    "li",
                    {
                      ...
                      style: "transform: translate3d(" + _vm.currentIndex * -100 + "%, 0px, 0px);"
                    },
                    [
                      _c("div", { staticClass: "light-gallery__image" }, [
                        ...
                        _c("img", {
                          ...
                          refInFor: true,
                          attrs: {
                            src: _vm.shouldPreload(imageIndex) ? image.url : false
                          },
                          on: {
                            load: function($event) {
            ...
            _vm._v(" "),
            _vm.currentIndex + 1 < _vm.images.length ? _c(
              "button",
              {
...
function install(Vue, options) {
  ...
  if (componentId === void 0)
    componentId = "LightGallery";
  Vue.component(componentId, LightGallery);
}
var wrapper = {
  install
};
var vue_light_gallery_esm_default = wrapper;
export {
  LightGallery,
  vue_light_gallery_esm_default as default,
  install
};
//# sourceMappingURL=vue-light-gallery.js.map
